...
OV_CONFIG_RELEASE_OPTION(ov::intel_gpu::hint, graph_compiler_optimization_level, ov::hint::Graph_compiler_level::ADVANCED, "Graph compiler optimization level Basic, Intermediate, Advanced")

...
class TRANSFORMATIONS_API RoPEFusionPSU0Model;
...
class ov::pass::RoPEFusionPSU0Model : public ov::pass::MatcherPass {
public:
    OPENVINO_MATCHER_PASS_RTTI("RoPEFusionPSU0Model");
    RoPEFusionPSU0Model();
};
